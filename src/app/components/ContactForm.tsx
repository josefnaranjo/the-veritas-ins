...
export default function ContactPage() {
  ...
  // reset status if user edits after success/error
  useEffect(() => {
      ...
      <div className="w-full max-w-xl px-6 lg:px-12">
        ...
        <div className="flex items-center mb-6">
          <Link
            ...
            className="inline-flex items-center justify-center p-2 rounded-full text-blue-700 hover:bg-blue-100 transition shadow-sm"
          >
        ...
        <p className="mb-6 text-gray-700">
          ...
          form below and someone from our team will follow up. Fields marked
          with * are required.
        </p>
